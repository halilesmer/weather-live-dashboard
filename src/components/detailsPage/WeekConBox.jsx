...
const WeekConBox = () => {
  ...
  return (
    <div className="details-con_week-con_box-con grid gap-7  justify-items-center items-center grid-cols-[repeat(auto-fit,minmax(60px,1fr))]  w-full h-auto text-center bg-[#f6f6f8] pt-4 pb-4 pr-4 pl-4">
