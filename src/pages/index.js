    ...
    <>
      ...
      {weatherData && (
        <main className="main-con grid gap-0 md:grid-cols-12 auto-rows-auto grid-flow-row pr-3 pl-3 pb-5">
          ...
          <div className="todays-highlights_con w-full  bg-[#f6f6f8] pt-4 pb-4">
            <div className="todays-highlights_header-con pb-4 pt-3 text-center text-3xl bg-[#ffffff] w-full ">
              <p>Today&apos;s Highlights</p>
            </div>
            <div className=" grid md:col-span-8 gap-5  justify-items-center items-center grid-cols-[repeat(auto-fill,minmax(240px,1fr))] w-full h-auto text-center bg-[#f6f6f8] pt-4 pb-4">
